...
//                               (controller.thisWeek.fold(0, (prev, HabitsModel model)=> prev + model.times)).toString(),
//                               false),
//                           _buildStatsColumn(context, "This Day",
//                               (controller.thisDay.fold(0, (prev, HabitsModel model)=> prev+ model.times)).toString(),
//                               true),
//                           _buildStatsColumn(context, "This Month",
//                               (controller.thisMonth.fold(0, (prev, HabitsModel model)=>prev + model.times)).toString(),
//                               false),
//                         ],
//                       ),
//                     ),
