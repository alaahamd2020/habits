                          ...
                          child: Container(
                            ...
                            child: TextButton(
                              onPressed: () {
                                controller.addHabit(
                                  HabitsModel(
                                    (controller.habits.isEmpty ? 1 : int.parse(controller.habits.last.id!) + 1).toString(),
                                    _count.toString(),
                                    (controller.habits.isEmpty? '0' :
                                      _dateTime.difference(controller.habits.last.date!).inDays < 1 ? 0 :
                                      _dateTime.difference(controller.habits.last.date!).inDays - 1)
                                        .toString(),
                                    _dateTime,
                                    DateTime.now(),
                                  ),
