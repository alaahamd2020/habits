...
class _AddTopicState extends State<AddTopic> {
  ...
  Widget build(BuildContext context) {
    final titleController = TextEditingController(
      text: widget.topicModel?.title,
    );
    final descriptionController = TextEditingController(
      text: widget.topicModel?.description,
    );
    final targetController = TextEditingController(
      text: widget.topicModel?.target.toString(),
    );
                ...
                child: Column(
                  ...
                  children: [
                            ...
                            children: [
                              TextCustom(
                                widget.topicModel?.userId == null
                                    ? S.of(context).add_topic
                                    : '${S.of(context).edit} ${widget.topicModel?.title}',
                                fontSize: 22,
                                bold: true,
                    ...
                    _buildInputField(
                      ...
                      label: '${S.of(context).target} (${S.of(context).days})',
                      controller: targetController,
                      hint: '${S.of(context).target}...',
